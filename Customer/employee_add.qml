    ...
    Image {
        ...
        Rectangle {
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter Name of Product") //make the text dynamic, when shipping Date placeholder will say Enter date, when warrenty it says enters years/
            }
        ...
        Rectangle {
            ...
            MouseArea{
                ...
                onClicked:
                {
                    ...
                    setQMLSources("employee_dash.qml")
                }
            }
        }
