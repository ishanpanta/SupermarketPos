...
import "."
//IDK how to do have the previous combo_box setting//
Item {
    width: 1116
    height: 718
    ...
    Image {
        ...
        Rectangle {
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                text: Style.description //make the text dynamic, when shipping Date placeholder will say Enter date, when warrenty it says enters years/
            }
        ...
        Rectangle {
            ...
            MouseArea{
                ...
                onClicked:
                {
                    Style.description = product_enter.text
                    console.log(description_combo.currentText)
                    console.log(product_enter.text)
                    console.log(Style.description)
                    if (pd.description(Style.description) === description_combo.currentText)
                    {
                        console.log("kunt")
                        pd.updateData(sno_enter.text, name_enter.text, price_enter.text,product_enter.text, description_emp.text,item_type.currentText, location_enter.text, quantity_enter.text)
                    }
                    else
                    {
                        console.log("lol")
                        pd.updateData(sno_enter.text, name_enter.text, price_enter.text,product_enter.text, description_combo.currentText,item_type.currentText, location_enter.text, quantity_enter.text)
                    }
