    ...
    Image {
        ...
        Rectangle {
            ...
            TextField {
                ...
                anchors.topMargin: 0
                layer.enabled: true
                placeholderText: ("Enter Employee Serial Number")
            }
        }
        Rectangle {
            id: name
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter Name of Employee")
            }
        }
        Rectangle {
            id: age
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter Age of Employee")
            }
        }
        Rectangle {
            id: dateJoined
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter Date joined")
            }
        }
        ...
        Rectangle {
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter employee time on monday (i.e. 10:30 PM - 4 AM)")
            }
        }
        ...
        Rectangle {
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter employee time on Tuesday (i.e. 10:30 PM - 4 AM)") //make the text dynamic, when shipping Date placeholder will say Enter date, when warrenty it says enters years/
            }}
        ...
        Rectangle {
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter employee time on wednesday (i.e. 10:30 PM - 4 AM)")
            }
        }
        ...
        Rectangle {
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter employee time on thursday (i.e. 10:30 PM - 4 AM)")
            }
        }
        ...
        TextField {
            ...
            color: "black"
            layer.enabled: true
            placeholderText: ("Enter employee time on firday (i.e. 10:30 PM - 4 AM)")
        }
    }
        Rectangle {
        ...
        TextField {
            ...
            color: "black"
            layer.enabled: true
            placeholderText: ("Enter employee time on saturday (i.e. 10:30 PM - 4 AM)")
        }
    }
        Rectangle {
            id: sundayrec
        ...
        TextField {
            ...
            color: "black"
            layer.enabled: true
            placeholderText: ("Enter employee time on sunday (i.e. hr:min:sec PM/AM)")
        }
    }
        ...
        Rectangle {
            ...
            MouseArea{
                ...
                onClicked:
                {
                    sd.insertData(sno_enter.text, name_enter.text, age_enter.text, date_joined_enter.text, monday_enter.text, tuesday_enter.text, wednesday_enter.text, thursday_enter.text, friday_enter.text, saturday_enter.text, sunday_enter.text)
