    ...
    Image {
        ...
        Rectangle {
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter Email of the employee")
            }
        }
        ...
        Rectangle {
            ...
            TextField {
                ...
                color: "black"
                layer.enabled: true
                placeholderText: ("Enter password of the employee") //make the text dynamic, when shipping Date placeholder will say Enter date, when warrenty it says enters years/
            }}
        ...
        TextField {
            ...
            color: "black"
            layer.enabled: true
            placeholderText: ("Enter employee date of birth (i.e. dd-mm-yy)")
        }
    }
        Rectangle {
        ...
        TextField {
            ...
            color: "black"
            layer.enabled: true
            placeholderText: ("Enter working since date (i.e. dd-mm-yy)")
        }
    }
        ...
        Rectangle {
            ...
            MouseArea{
                ...
                onClicked:
                {
                    ed.insertData(sno_enter.text, name_enter.text, email_enter.text, password_enter.text, gender.currentText, contact_number_enter.text, address_enter.text, date_of_birth_enter.text, working_since_enter.text)
